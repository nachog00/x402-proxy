...
mod tests {
    ...
    fn signature_matches_viem_vector() {
        // Generated by proxies/x402/gen-upto-vector.mjs (viem) — byte-identical
        // Permit2 EIP-712 hashing (domain with no version, alphabetical
        // referenced-type order) is the whole point of this test.
        const VIEM_SIG: &str = "0x7ee654b82c69593e250c53dfed5e94d518f1a327e2b8f6e2f4714f167eed0e17220974433d812d17a54c884893cc69819886baff9bed0728fc8a9ad042a65e741b";
        let scheme = UptoPermit2::new(test_signer());
        let nonce = B256::from(U256::from(1u64));
        let payment = scheme
            .sign_at(&apify_upto_entry(), 2, nonce, 1_700_000_060, 1_700_000_000)
